...
const u8 gText_PkmnFainted_FldPsn[] = _("{STR_VAR_1} a survécu à l'empoisonnement. Le poison s'est estompé.\p\n");
...
const u8 gText_PkmnsNickname[] = _(": Surnom ?");
...
const u8 gText_MayBrendanMatchCallDesc[] = _("LE/LA VOISIN(E)");
...
const u8 gText_Stats_CatchRate_VeryHard[]       = _("TRES DURE");
const u8 gText_Stats_CatchRate_Difficult[]      = _("DIFFICULTER");
const u8 gText_Stats_CatchRate_Medium[]         = _("MOYEN");
const u8 gText_Stats_CatchRate_Relaxed[]        = _("DÉTENDU");
const u8 gText_Stats_CatchRate_Easy[]           = _("FACIL");
...
const u8 gText_Stats_FAST[]          = _("VITE");
...
const u8 gText_Stats_eggGroup_FLYING[]      = _("VOLE");
...
const u8 gText_Dex_OWN[]    = _("ATTRAPPE");
...
const u8 gText_EVO_PreEvo[]                         = _("{STR_VAR_1} evolue de {STR_VAR_2}");
const u8 gText_EVO_PreEvo_PE_Mega[]                 = _("{STR_VAR_1} mega evolue avec {STR_VAR_2}");
...
const u8 gText_EVO_TRADE[]                          = _("Vente");
const u8 gText_EVO_TRADE_ITEM[]                     = _("Vente, holding {STR_VAR_2}");
